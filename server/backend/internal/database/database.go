...
func DatabaseConnect() *gorm.DB {
	...
	imageNames := []string{
		"personal-achievements/famous.webp",
		"personal-achievements/leader.webp",
		"personal-achievements/combat_unit.webp",
		"personal-achievements/populizer.webp",
		"personal-achievements/baptism.webp",
		"personal-achievements/march.webp",
		"personal-achievements/victory-banner.webp",
		"personal-achievements/milestone.webp",
		"personal-achievements/will-to-win.webp",
		"personal-achievements/change.webp",
		"personal-achievements/receiver.webp",
		"personal-achievements/feedback.webp",
		"personal-achievements/bug.webp",
		"personal-achievements/developer.webp",
	}
	keys := []string{
		"confirmed",
		"leader",
