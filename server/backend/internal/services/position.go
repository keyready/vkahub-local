...
type PositionService interface {
	...
	FetchAllPositions(s string) (httpCode int, err error, positions []models.PositionModel)
}
...
func (p PositionServiceImpl) FetchAllPositions(s string) (httpCode int, err error, positions []models.PositionModel) {
